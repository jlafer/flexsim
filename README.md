...
## Terminology
Due to the depth of the domain object structure, this documentation refers to the following symantic elements of a domain description:
...
### center
This is an object, which describes the location of the contact center. It has the following properties: `country`, `state`, `city` and `zip`.
